        ...
        <div class="container py-5 h-100">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="bForder-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">register</h3>
                            <form name="registerForm" action="register" onsubmit="return validateInput()" method="post"
                                  autocomplete="on">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input type="password" class="form-control form-control-lg"
                                                   id="repeatepassword" name="repeatepassword" required/>
